...
Open the PowerBI report. Explain the data came for the storm samples database. With this report a business analyst can analyze storm damage to crops by state.
