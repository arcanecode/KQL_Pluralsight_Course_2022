...
In query languages it is common to see if a date lies in a date range. That’s where the between operators we’ll see some examples of its use in this section.
